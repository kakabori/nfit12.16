...
It takes the absolute value of qx. This is to deal with qx = 0 point, where
...
/****************************************************************************************
This function performs the integration over the structure factor along qy direction
at the input qx value
The lower and upper integration limits depend on qx, so their values get retrieved
by ModelCalculator::getLowerLimit() and ModelCalculator::getUpperLimit() functions
The interpolant for the structure factor along qy must get recalculated for each qx
****************************************************************************************/
...
the interpolated value of the structure factor at given qx, qy, and qz
The interpolation over the structure factor is done in (qr,qz) tuple
This function calculates qr corresponding to the input qy and currQx
...
double ModelCalculator::s_qyIntegrandWrapper(double qy, void *ptr)
{
	...
	return exp( p->spStrFct.val(log(qr + SMALLNUM)) );
}
...
/****************************************************************************************
Return the lower limit of the qy integration for the current value of qx and qz
It is derived in an appropirate report
****************************************************************************************/
...
/****************************************************************************************
Return the upper limit of the qy integration for the currenct value of qx and qz
It is derived in an appropriate report
****************************************************************************************/
